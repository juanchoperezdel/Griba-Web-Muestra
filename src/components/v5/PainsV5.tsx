...
// Pains de V5: mismo esqueleto que PainsV4 pero (a) layout mobile más apretado
// (número más chico, viñetas a ancho completo en mobile) y (b) copy del punto 04
// afilado con el research del rubro (la administradora cobra la cuota → te
// enterás tarde de la mora; planes caídos que recomprás con tu plata).
export function PainsV5() {
  const pains = [
    {
      number: "01",
    ...
    {
      number: "04",
      title: "El plan de ahorro lo sostenés a mano.",
      bullets: [
        "Tu módulo más rentable, dependiendo de planillas",
        "La cuota la cobra la administradora: te enterás tarde de quién está en mora",
        "Adjudicados que se pierden entre archivos",
        "Planes que se caen y terminás recomprando con tu propia plata",
      ],
    },
  ];
