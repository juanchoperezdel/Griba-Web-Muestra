...
// Testimonios de V5: sin avatares stock (solo nombre/cargo + empresa) y con
// "Todo el país" en lugar de "15 provincias" (dato sin confirmar por el cliente).
          ...
          <div className="grid grid-cols-3 gap-6 sm:gap-4">
            {stats.map((stat, idx) => (
              <div key={idx} className="text-center">
                <div className="font-display text-xl sm:text-3xl lg:text-4xl text-white mb-1 leading-tight">
                  {stat.value}
                </div>
