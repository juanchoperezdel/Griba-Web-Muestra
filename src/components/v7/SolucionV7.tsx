...
// Fork de v6/SolucionV6.tsx. Mismo mecanismo y mismo copy — está bien y es
// real. Los únicos cambios son de robustez: motion → Reveal, para que las
// tarjetas no queden invisibles si el observer no dispara.
//
// Acá aterriza el dolor "el WhatsApp oficial no te funciona" que en V6 era un
// bloque de Pains. Como objeción de plataforma tiene sentido; como gancho de
// entrada era demasiado técnico y ningún anuncio lo usa.
export function SolucionV7() {
  const steps = [
    {
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-slate-500">
            Cuatro piezas que trabajan juntas para reactivar a quien ya te
            compró.
          </p>
        </div>
